...
日常工作中经常谈到 DevOps 这个词，但有几个问题一直没搞清楚：我们的团队到底做到什么程度了？不同组之间怎么衡量？有没有统一标准？

带着这些疑问，我做了 **DevOps 成熟度模型** 这个项目。

如果只是写个 wiki、发个 excel 让大家填，效率低，结果也难追踪。所以需要一个更现代化、更高效的方式——**DevOps Maturity** 就是这个开源项目。
