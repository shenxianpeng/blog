...
仔细想想，其实也不奇怪——我之前写过几篇质量还不错的英文文章，比如 [使用 Gcov 和 LCOV 做 C/C++ 项目的代码覆盖率](../../2021/gcov-example/)，吸引了不少海外读者。  
...
很多看似麻烦的小事，都可以通过 AI + 自动化解决。写博客、技术文档双语支持、团队知识库国际化，思路是一样的。

如果你也有写博客的习惯，希望这篇文章能给你一些启发。
