...
title: "PyPI 开源项目"
weight: 1
summary: "我在 PyPI 上维护的 Python 开源包，涵盖 DevOps、数据可视化等领域"
showDate: false
...
以下是我在 [Python 包索引 (PyPI)](https://pypi.org) 上作为所有者或维护者发布的开源 Python 包（[xpshen](https://pypi.org/user/xpshen/)），涵盖了代码质量、CI/CD、数据可视化等领域。
