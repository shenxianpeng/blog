...
pipeline {
    ...
    parameters {
        ...
        choice(
            ...
            description: 'Required: pick a repo you want to build')
        string(
            name: 'BRANCH', 
            defaultValue: '', 
            description: 'Required: chose a branch you want to checkout')
        string(
            name: 'BUILD_NO', 
            defaultValue: '', 
            description: 'Required: input build number')
        string(
            name: 'JIRA_NO', 
            defaultValue: '', 
            description: 'Optional: input jira ticket number for commit message')
    }
